...
var toggleSubmenu = function toggleSubmenu() {
  ...
  var subButtons = modalMenu.querySelectorAll('.modal-menu__sub-button');
...
},{"./modules/accordion/init-accordion":3,"./modules/form-validate/form":5,"./modules/modals/init-modals":11,"./modules/select/custom-select":14,"./utils/ios-vh-fix":18}],2:[function(require,module,exports){
"use strict";
...
var openMenuCallback = function openMenuCallback() {
  // const menuButton = document.querySelector('.menu-button');
  // const mainHeader = document.querySelector('.main-header');
  // if (menuButton && mainHeader) {
  //   menuButton.classList.add('menu-button--opened');
  //   mainHeader.classList.add('main-header--menu-mode');
  //   mainHeader.setAttribute('tabindex', '-1');
  // }
};
var closeMenuCallback = function closeMenuCallback() {
  // const menuButton = document.querySelector('.menu-button');
  // const mainHeader = document.querySelector('.main-header');
  // if (menuButton && mainHeader) {
  //   menuButton.classList.remove('menu-button--opened');
  //   mainHeader.classList.remove('main-header--menu-mode');
